...
from finetune_studio.benchmarks.scoring import (
    extract_mcq_answer, extract_math_answer, normalize_math_answer,
    score_truthfulqa, score_winogrande
)
...
# ══════════════════════════════════════════════════════════════
# MMLU — Multiple choice with proper extraction
# ══════════════════════════════════════════════════════════════
print("\n--- MMLU ---")
...
# ══════════════════════════════════════════════════════════════
# HellaSwag — Multiple choice with proper extraction
# ══════════════════════════════════════════════════════════════
print("\n--- HellaSwag ---")
...
# ══════════════════════════════════════════════════════════════
# ARC Challenge — Multiple choice with proper extraction
# ══════════════════════════════════════════════════════════════
print("\n--- ARC Challenge ---")
...
# ══════════════════════════════════════════════════════════════
# GSM8K — Math with proper answer extraction
# ══════════════════════════════════════════════════════════════
print("\n--- GSM8K ---")
...
print(f"\n{'='*60}")
print(f"PHI-4 14B BASELINE RESULTS (v3 — proper scoring)")
print(f"{'='*60}")
